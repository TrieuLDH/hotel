        ...
        <Container className="mb-2 ">
            ...
            <Row>
                <h4 className="text-center">
                    Services at <span className="hotel-color"> lakeSilde -</span>Hotel
                    <span className="gap-2">
                        <FaClock /> - 24-Hour Font Desk</span>
                </h4>
            </Row>
            <hr />
                ...
                <Col>
                    <Card>
                        <Card.Body>
                            ...
                            <Card.Text>Stay connected with hihg-speed internet access.</Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
                ...
                <Col>
                    <Card>
                        <Card.Body>
                            ...
                            <Card.Text>Star your day with a delicous breakfast buffer.</Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
